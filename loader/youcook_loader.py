...
class Youcook_DataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.isfile(os.path.join(self.video_root, 'youcook', str(task), video_id + '.mp4')):
            video_path = os.path.join(self.video_root, 'youcook', str(task), video_id + '.mp4')
        elif os.path.isfile(os.path.join(self.video_root, 'youcook', str(task), video_id + '.mkv')):
            video_path = os.path.join(self.video_root, 'youcook', str(task), video_id + '.mkv')
        elif os.path.isfile(os.path.join(self.video_root, 'youcook', str(task), video_id + '.webm')):
            video_path = os.path.join(self.video_root, 'youcook', str(task), video_id + '.webm')
        else:
            raise ValueError
